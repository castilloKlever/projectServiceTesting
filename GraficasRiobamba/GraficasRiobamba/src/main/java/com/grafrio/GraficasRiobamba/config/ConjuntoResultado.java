...
public class ConjuntoResultado {
    ...
    public BigInteger getBigInt(int nCol) throws Exception {
        try {
            BigInteger val = BigInteger.valueOf(Long.valueOf(this.Datos.get(indFil)[nCol].toString()));
            return val;
        } catch (Exception e) {
            throw e;
        }
    ...
    public BigInteger getBigInt(String nomCol) throws Exception {
        try {
            BigInteger val = BigInteger.valueOf(Long.valueOf(this.Datos.get(indFil)[Find(nomCol)].toString()));
            return val;
        } catch (Exception e) {
            throw e;
        }
    ...
    public Date getDate(int nCol) throws Exception {
        try {
            ...
            try {
                Timestamp stamp = (Timestamp) this.Datos.get(indFil)[nCol];
    ...
    public Timestamp getTimestamp(int nCol) throws Exception {
        try {
            return (Timestamp) this.Datos.get(indFil)[nCol];
        } catch (Exception e) {
            throw e;
        }
    }
    ...
    public java.util.Date getUtilDate(int nCol) throws Exception {
        try {
            return (java.util.Date) (this.Datos.get(indFil)[nCol]);
        } catch (Exception e) {
            throw e;
        }
    }

    public java.util.Date getUtilDate(String nomCol) throws Exception {
        try {
            return (java.util.Date) (this.Datos.get(indFil)[Find(nomCol)]);
        } catch (Exception e) {
            throw e;
        }
    }
